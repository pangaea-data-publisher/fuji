...
PROJECTNAME = "Fuji"  # u'F-uji Server'
...
htmlhelp_basename = "fuji-toolsdoc"
...
latex_documents = [
    ("index", "fuji.tex", "Fuji Documentation", "The F-uji authors", "fuji_manual"),
]
...
man_pages = [
    ("index", "fuji.tex", "Fuji Documentation", ["The F-uji authors"], 1),
]
...
texinfo_documents = [
    (
        ...
        "The Fuji authors",
        "fuji",
        "FUJI, a service to evaluate FAIR data objects based on FAIRsFAIR Metrics",
        "Miscellaneous",
    ),
]
