...
project = PROJECTNAME
copyright = u'2020-today PANGAEA'
...
latex_documents = [
  ('index', 'fuji.tex', u'Fuji Documentation',
   u'The F-uji authors', 'fuji_manual'),
]
...
texinfo_documents = [
  ('index', 'fuji', u'Fuji Documentation',
   u'The Fuji authors', 'fuji', 'FUJI, a service to evaluate FAIR data objects based on FAIRsFAIR Metrics',
   'Miscellaneous'),
]
