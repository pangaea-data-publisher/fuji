...
class API(Model):
    ...
    def __init__(
        ...
        :type id: int
        :param metric_identifier: The metric_identifier of this API.  # noqa: E501
        :type metric_identifier: str
        :param metric_name: The metric_name of this API.  # noqa: E501
        :type metric_name: str
        :param metric_tests: The metric_tests of this API.  # noqa: E501
        :type metric_tests: Dict[str, FAIRResultEvaluationCriterium]
        :param test_status: The test_status of this API.  # noqa: E501
        :type test_status: str
        :param score: The score of this API.  # noqa: E501
        :type score: FAIRResultCommonScore
        :param maturity: The maturity of this API.  # noqa: E501
        :type maturity: int
        :param output: The output of this API.  # noqa: E501
        :type output: APIOutput
        :param test_debug: The test_debug of this API.  # noqa: E501
    ...
    def metric_identifier(self) -> str:
        """Gets the metric_identifier of this API.


        :return: The metric_identifier of this API.
        :rtype: str
        """
    ...
    def metric_identifier(self, metric_identifier: str):
        """Sets the metric_identifier of this API.


        :param metric_identifier: The metric_identifier of this API.
        :type metric_identifier: str
        """
    ...
    def metric_name(self) -> str:
        """Gets the metric_name of this API.


        :return: The metric_name of this API.
        :rtype: str
        """
    ...
    def metric_name(self, metric_name: str):
        """Sets the metric_name of this API.


        :param metric_name: The metric_name of this API.
        :type metric_name: str
        """
    ...
    def metric_tests(self) -> dict[str, FAIRResultEvaluationCriterium]:
        """Gets the metric_tests of this API.


        :return: The metric_tests of this API.
    ...
    def metric_tests(self, metric_tests: dict[str, FAIRResultEvaluationCriterium]):
        """Sets the metric_tests of this API.


        :param metric_tests: The metric_tests of this API.
        :type metric_tests: Dict[str, FAIRResultEvaluationCriterium]
        """
    ...
    def test_status(self) -> str:
        """Gets the test_status of this API.


        :return: The test_status of this API.
        :rtype: str
        """
    ...
    def test_status(self, test_status: str):
        """Sets the test_status of this API.


        :param test_status: The test_status of this API.
        :type test_status: str
        """
    ...
    def score(self) -> FAIRResultCommonScore:
        """Gets the score of this API.


        :return: The score of this API.
    ...
    def score(self, score: FAIRResultCommonScore):
        """Sets the score of this API.


        :param score: The score of this API.
        :type score: FAIRResultCommonScore
        """
        if score is None:
    ...
    def maturity(self) -> int:
        """Gets the maturity of this API.


        :return: The maturity of this API.
        :rtype: int
        """
    ...
    def maturity(self, maturity: int):
        """Sets the maturity of this API.


        :param maturity: The maturity of this API.
        :type maturity: int
        """
    ...
    def output(self) -> APIOutput:
        """Gets the output of this API.


        :return: The output of this API.
        :rtype: APIOutput
        """
        return self._output

    @output.setter
    def output(self, output: APIOutput):
        """Sets the output of this API.


        :param output: The output of this API.
        :type output: APIOutput
        """
    ...
    def test_debug(self) -> Debug:
        """Gets the test_debug of this API.


        :return: The test_debug of this API.
        :rtype: Debug
        """
    ...
    def test_debug(self, test_debug: Debug):
        """Sets the test_debug of this API.


        :param test_debug: The test_debug of this API.
        :type test_debug: Debug
        """
