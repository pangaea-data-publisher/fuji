...
class FAIRResultEvaluationCriterium(Model):
    ...
    """
    def __init__(self, metric_test_name: str=None, metric_test_score: int=None, metric_test_status: str='fail'):  # noqa: E501
    ...
    @property
    def metric_test_score(self) -> int:
    ...
    def metric_test_score(self, metric_test_score: int):
