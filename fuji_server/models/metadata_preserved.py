...
class MetadataPreserved(FAIRResultCommon):
    ...
    """
    swagger_types = {"output": "MetadataPreservedOutput", "test_debug": "Debug"}
    ...
    @property
    def output(self):
        """Gets the output of this MetadataPreserved.  # noqa: E501


        :return: The output of this MetadataPreserved.  # noqa: E501
    ...
    @property
    def test_debug(self):
        """Gets the test_debug of this MetadataPreserved.  # noqa: E501


        :return: The test_debug of this MetadataPreserved.  # noqa: E501
        :rtype: Debug
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetadataPreserved, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadataPreserved):
            return False
