...
class DataAccessLevel(Model):
    ...
    """
    def __init__(self, id: int=None, metric_identifier: str=None, metric_name: str=None, metric_tests: List[FAIRResultEvaluationCriterium]=None, test_status: str='fail', score: FAIRResultCommonScore=None, output: DataAccessOutput=None, test_debug: Debug=None):  # noqa: E501
