...
class DataAccessLevel(Model):
    ...
    """
    def __init__(self, id: int=None, metric_identifier: str=None, metric_name: str=None, metric_tests: Dict[str, FAIRResultEvaluationCriterium]=None, test_status: str='fail', score: FAIRResultCommonScore=None, maturity: str='incomplete', output: DataAccessOutput=None, test_debug: Debug=None):  # noqa: E501
    ...
    def maturity(self, maturity: str):
        """Sets the maturity of this DataAccessLevel.


        :param maturity: The maturity of this DataAccessLevel.
        :type maturity: str
        """
