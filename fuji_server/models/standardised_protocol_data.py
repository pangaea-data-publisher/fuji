...
class StandardisedProtocolData(Model):
    ...
    """
    def __init__(self, id: int=None, metric_identifier: str=None, metric_name: str=None, test_status: str='fail', score: FAIRResultCommonScore=None, output: StandardisedProtocolDataOutput=None, test_debug: Debug=None):  # noqa: E501
