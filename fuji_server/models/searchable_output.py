...
class SearchableOutput:
    ...
    """
    swagger_types = {"search_mechanisms": "list[OutputSearchMechanisms]"}

    attribute_map = {"search_mechanisms": "search_mechanisms"}

    def __init__(self, search_mechanisms=None):
        """SearchableOutput - a model defined in Swagger"""
        self._search_mechanisms = None
        self.discriminator = None
        if search_mechanisms is not None:
            self.search_mechanisms = search_mechanisms

    @property
    def search_mechanisms(self):
        """Gets the search_mechanisms of this SearchableOutput.  # noqa: E501


        :return: The search_mechanisms of this SearchableOutput.  # noqa: E501
        :rtype: list[OutputSearchMechanisms]
        """
        return self._search_mechanisms

    @search_mechanisms.setter
    def search_mechanisms(self, search_mechanisms):
        ...
        :type: list[OutputSearchMechanisms]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchableOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchableOutput):
            return False
