...
class CoreMetadata(FAIRResultCommon):
    ...
    """
    swagger_types = {"output": "CoreMetadataOutput", "test_debug": "Debug"}
    ...
    @property
    def output(self):
        """Gets the output of this CoreMetadata.  # noqa: E501


        :return: The output of this CoreMetadata.  # noqa: E501
    ...
    @property
    def test_debug(self):
        """Gets the test_debug of this CoreMetadata.  # noqa: E501


        :return: The test_debug of this CoreMetadata.  # noqa: E501
        :rtype: Debug
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreMetadata):
            return False
