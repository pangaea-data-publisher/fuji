...
class StandardisedProtocolMetadata(FAIRResultCommon):
    ...
    """
    swagger_types = {"output": "StandardisedProtocolMetadataOutput", "test_debug": "Debug"}
    ...
    @property
    def output(self):
        """Gets the output of this StandardisedProtocolMetadata.  # noqa: E501


        :return: The output of this StandardisedProtocolMetadata.  # noqa: E501
    ...
    def output(self, output):
        ...
        :type: StandardisedProtocolMetadataOutput
        """
    ...
    @property
    def test_debug(self):
        """Gets the test_debug of this StandardisedProtocolMetadata.  # noqa: E501


        :return: The test_debug of this StandardisedProtocolMetadata.  # noqa: E501
        :rtype: Debug
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StandardisedProtocolMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StandardisedProtocolMetadata):
            return False
