...
class StandardisedProtocolDataOutput:
    ...
    """
    swagger_types = {"standard_data_protocol": "str"}

    attribute_map = {"standard_data_protocol": "standard_data_protocol"}

    def __init__(self, standard_data_protocol=None):
        """StandardisedProtocolDataOutput - a model defined in Swagger"""
        self._standard_data_protocol = None
        self.discriminator = None
        if standard_data_protocol is not None:
            self.standard_data_protocol = standard_data_protocol

    @property
    def standard_data_protocol(self):
        """Gets the standard_data_protocol of this StandardisedProtocolDataOutput.  # noqa: E501


        :return: The standard_data_protocol of this StandardisedProtocolDataOutput.  # noqa: E501
        :rtype: str
        """
        return self._standard_data_protocol

    @standard_data_protocol.setter
    def standard_data_protocol(self, standard_data_protocol):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StandardisedProtocolDataOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StandardisedProtocolDataOutput):
            return False
