...
SCHEMAORG_MAPPING = '{title: name, type: "@type", date: datePublished."@value" ||datePublished , ' \
                           ...
                           'object_identifier: ("@id" || url."@id" || identifier.value ) || url, object_content_identifier: (distribution.contentUrl || distribution[*].contentUrl)}'

DATACITE_JSON_MAPPING = '{ object_identifier: id, type: types.resourceTypeGeneral,  ' \
